...
def calculate_threshold(anomaly_scores, percentiles=[0.01, 0.005, 0.001]):
    thresholds = []
...
if __name__ == "__main__":
    ...
    with open('./output/hdfs/test_normal', 'r') as file: # CHANGE PATH
        content = file.read()
