...
def split_abnormal_test_validation(df, test_size):
...
def run(options):
    ...
    deeplog_file_generator(os.path.join(output_dir, 'test_abnormal'), df_test_abnormal, ["EventId", "element_labels"])
    deeplog_file_generator(os.path.join(output_dir, 'valid_abnormal'), df_valid_abnormal, ["EventId", "element_labels"])
